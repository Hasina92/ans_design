                        ...
                        <section class="checkout-section">
                            <form class="checkout-form" action="traitement-commande.php" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="fullname" name="fullname" placeholder="Votre nom complet" required value="<?php echo htmlspecialchars($user_details['nom_complet'] ?? ''); ?>">
                                </div>

                                <div class="form-group">
                                    <label for="email">Adresse e-mail <span>*</span></label>
                                    <!-- MODIFICATION 2 : Champ pré-rempli -->
                                    <input type="email" id="email" name="email" placeholder="exemple@mail.com" required value="<?php echo htmlspecialchars($user_details['email'] ?? ''); ?>">
                                </div>

                                <div class="form-group">
                                    <label for="phone">Numéro de téléphone <span>*</span></label>
                                    <input type="tel" id="phone" name="phone" placeholder="Ex: +261 34 12 345 67"
                                        required>
                                </div>
                                ...
                                <?php foreach ($_SESSION['panier'] as $article): ?>
                                    <input type="hidden" name="demande_article[]" value="<?php echo htmlspecialchars($article['demande'] ?? ''); ?>">
                                <?php endforeach; ?>


                                <!-- Bouton -->
                                <button type="submit" class="btn-red" id="open-popup-validation-commande">Valider la commande</button>
                            </form>
                        </section>
                    ...
                    <div class="resume-produit">
                        ...
                        <div class="container-resume-produit">
                                ...
                                <div class="card-resume-produit">
                                    <div class="info-resume-produit">
                                        ...
                                        <div class="text-resume-produit">
                                            ...
                                            <div class="options-details" style="font-size: 0.8em; color: #555; margin-top: 4px;">
                                                <?php foreach ($article['options'] as $nom_option => $valeur_option): ?>
                                                    <span><?php echo htmlspecialchars($nom_option); ?>: <strong><?php echo htmlspecialchars($valeur_option); ?></strong></span><br>
                                                <?php endforeach; ?>
                                            </div>
                            ...
                            <div class="livraison-resume-produit">
                                ...
                                <span class="livraison-total"><?php echo number_format($frais_livraison, 0, ',', '.'); ?> AR</span>
                            </div>
