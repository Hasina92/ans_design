        ...
        <div class="wrapper">
            <div class="title">
                ...
                <div class="inner-title">
                    <p>Connecté en tant que : <?php echo htmlspecialchars($user_info['nom_complet'] ?? 'Client'); ?></p>
                </div>
            </div>
                        ...
                        <?php foreach ($commandes as $commande): ?>
                            <div class="accordeon-card-compte">
                                <div class="accordeon-title-compte">
                                    ...
                                    $statut_class = $statuts[$commande['statut']] ?? 'en-attente';
                                    ?>
                                    <div class="order-etat <?= $statut_class ?>">
                                ...
                                <div class="accordeon-content-compte">
                                    <div class="order-summary">
                                        <div class="header-order-summary">
                                            <div class="society">
                                                <h5>ANS Design Print</h5><span>Votre partenaire impression</span>
                                            </div>
                                            <div class="order-detail">
                                        ...
                                        <div class="body-order-summary">
                                            <div class="facture">
                                                ...
                                                <span
                                                    class="name"><?php echo htmlspecialchars($user_info['nom_complet']); ?></span><br>
